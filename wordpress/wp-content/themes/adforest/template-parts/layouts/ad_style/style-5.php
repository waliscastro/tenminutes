                        ...
                        <div class="col-lg-9 col-xs-12 col-md-9 col-sm-12">
                            ...
                            <div class="details-text-section">
                                ...
                                <div class="details-post-ad">
                                    <ul class="new-details-pages-links"><li><a href="<?php echo adforest_set_url_param(get_author_posts_url($poster_id), 'type', 'ads');?>"><span><?php echo __('By', 'adforest');?></span><?php
                                        ...
                                        <li><a href="javascript:void(0)"><span><?php echo __('Posted', 'adforest');?></span><?php echo get_the_date();?></a></li>
                                ...
                                if (get_post_meta($pid, '_adforest_ad_status_', true) != "" && get_post_meta($pid, '_adforest_ad_status_', true) == 'active') {
                                    if ($adforest_theme['communication_mode'] == 'both' || $adforest_theme['communication_mode'] == 'message') {
                                        if (get_current_user_id() == "") {
                                            ...
                                            ?><div class="details-messages"><a class="btn btn-primary" href="<?php echo esc_url($redirect_url);?>"><i class="fa fa-envelope"></i><?php echo __('Send Message', 'adforest');?></a></div>
                                        <?php } else {
                                            ?><div class="details-messages"><a class="btn btn-primary" href="javascript:void(0);" role="button" data-toggle="modal" data-target=".price-quote"><i class="fa fa-envelope"></i><?php echo __('Send Message', 'adforest');?></a></div>
                                                    <?php
                                                }
                                            }
