...
<?php $msg_count = 0;
if (!$adforest_theme['sb_top_bar']) { return; }
...
<div class="container">
    <div class="row">
        <div class="sb-top-left col-md-8 col-sm-6 col-xs-12">
            <ul class="list-unstyled list-inline flo-left"><?php if (isset($adforest_theme['top_bar_pages']) && $adforest_theme['top_bar_pages'] != "" && count($adforest_theme['top_bar_pages']) > 0) {
                    foreach ($adforest_theme['top_bar_pages'] as $foot_page) {
                        $foot_page = apply_filters('adforest_language_page_id', $foot_page);
                                echo '<li><a href="' . esc_url(get_the_permalink($foot_page)) . '">' . esc_html(get_the_title($foot_page)) . '</a></li>'; }  } ?></ul>
