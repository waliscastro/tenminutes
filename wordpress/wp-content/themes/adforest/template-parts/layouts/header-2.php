...
<div class="sb-header">
    <div class="container">
        <div class="row">
            <div class="col-md-3 col-sm-12 col-xs-12 no-padding"><div class="logo"><?php get_template_part('template-parts/layouts/site', 'logo');?></div>
            </div>
            ...
            <div class="col-md-2 col-sm-3 no-padding col-xs-12">
                ...
                if (isset($adforest_theme['ad_in_menu']) && $adforest_theme['ad_in_menu']) {
                    ...
                    ?>
                    <a href="<?php echo esc_url($sb_ad_post_url);?>" class="btn btn-orange btn-block"><i class="fa fa-plus" aria-hidden="true"></i><?php echo esc_html($btn_text);?></a>
                    <?php
                }
                ?>
            </div>
